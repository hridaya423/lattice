...
export const exportToMarkdown = (data: ExportData) => {
  ...
  let markdown = `# AI Multi-Perspective Analysis\n\n`;
  ...
  markdown += `\n\n*Analysis generated by AI Analysis Platform*`;
  
  
  const blob = new Blob([markdown], { type: 'text/markdown;charset=utf-8' });
  const fileName = `analysis-${timestamp.getTime()}.md`;
...
export const exportToPDF = async (data: ExportData) => {
  ...
  let htmlContent = `
    <div style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 800px; margin: 0 auto; padding: 20px;">
      <div style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #2563eb; padding-bottom: 20px;">
        <h1 style="color: #2563eb; margin-bottom: 10px;">AI Multi-Perspective Analysis</h1>
  ...
  htmlContent += `
      <div style="margin-top: 40px; text-align: center; border-top: 1px solid #e2e8f0; padding-top: 20px;">
        <p style="color: #666; font-size: 12px; margin: 0;">Analysis generated by AI Analysis Platform</p>
      </div>
    </div>
  `;
  ...
  const options = {
    margin: [20, 15, 20, 15],
    filename: `analysis-${timestamp.getTime()}.pdf`,
